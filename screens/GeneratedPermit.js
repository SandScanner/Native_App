    ...
    const getHTMLString = (img_src) => {
      ...
      <div class="clear">
          ...
          <div class="width100 center">
              <img src=${img_src} width="140" class="qr-code" />
              <p class="font13"></p>
          </div>
          <p style="text-align: right;">அனுமதி எண். <strong>${vehicleData?.regNo}</strong></p>
      
          <div class="clear">
              <div class="left"><p>பதிவு எண். <strong>${vehicleData?.regNo + 6000000}</strong></p></div>
              <div class="right"><p>நாள் : <strong>${formatted_dob}</strong></p></div>
          </div>
      </div>
      <!-- <div class="center">
      ...
      <div class="rowWiseData">
          ...
          <div>(ii) செலுத்தப்பட்ட தொகை<br>
              <strong>₹ ${price} <br>(Inclusive of CGST Rs.${vehicleData?.gst}/- and SGST
                  Rs.${vehicleData?.gst}/-)</strong></div>
          <div>5. (i) மணல் கொண்டு செல்வதற்கான அனுமதி எண் / நாள்
              <br><strong>${vehicleData?.regNo}/ ${formatted_dob}</strong></div>
          <div>(ii) வண்டி எண் <br><strong>${vehicleData?.vehicleRegNumber}</strong></div>
          ...
          <!-- <div>8. அலுவலக முத்திரை <img src=${stamp_string} width="50" /></div> -->
